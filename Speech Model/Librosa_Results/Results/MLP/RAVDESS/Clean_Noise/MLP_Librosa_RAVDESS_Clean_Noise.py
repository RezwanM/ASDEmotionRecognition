...
# Rezwan Matin
# Thesis B
# Filename: MLP_Librosa_RAVDESS_Clean_Noise.py
# Date: 10/24/20
#
# Features:
...
plt.title('MLP_Custom_RAVDESS_Clean_Noise')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_MLP_Librosa_RAVDESS_Clean_Noise.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_MLP_Librosa_RAVDESS_Clean_Noise.png')
