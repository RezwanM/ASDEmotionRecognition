...
# Rezwan Matin
# Thesis B
# Filename: MLP_Librosa_TESS_Clean.py
# Date: 10/24/20
#
# Features:
...
plt.title('MLP_Custom_TESS_Clean')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_MLP_Librosa_TESS_Clean.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_MLP_Librosa_TESS_Clean.png')
