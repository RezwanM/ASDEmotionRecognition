...
# Rezwan Matin
# Thesis B
# Filename: RNN_Librosa_CREMA-D_Clean.py
# Date: 10/24/20
#
# Features:
...
df = pd.read_csv(r'/home/r_m727/All_Files/Corpus/Simulated/CREMA-D/CREMA-D_Librosa_Clean_RNN.csv', header=0, index_col=0)
...
y_less = df_less.iloc[0:6355, 36*median_num_frames].values
# Extract features of majority classes.
X_less = df_less.iloc[0:6355, list(range(36*median_num_frames))].values
print(y_less)
...
plt.title('RNN_Custom_CREMA-D_Clean')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_RNN_Librosa_CREMA-D_Clean.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_RNN_Librosa_CREMA-D_Clean.png')
