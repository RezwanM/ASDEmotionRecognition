...
# Rezwan Matin
# Thesis B
# Filename: RNN_Librosa_RAVDESS_Clean_Noise.py
# Date: 10/24/20
#
# Features:
...
df = pd.read_csv(r'/home/r_m727/All_Files/Corpus/Simulated/RAVDESS/RAVDESS_Librosa_Clean_Noise_RNN.csv', header=0, index_col=0)
...
y_less = df_less.iloc[0:2304, 36*median_num_frames].values
# Extract features of majority classes.
X_less = df_less.iloc[0:2304, list(range(36*median_num_frames))].values
print(y_less)
...
plt.title('RNN_Custom_RAVDESS_Clean_Noise')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_RNN_Librosa_RAVDESS_Clean_Noise.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_RNN_Librosa_RAVDESS_Clean_Noise.png')
