...
# Rezwan Matin
# Thesis B
# Filename: MLP_Librosa_RAVDESS_Clean_Conf.py
# Date: 10/24/20
#
# Features:
...
fig = plt.figure()
plot_confusion_matrix(confmat, class_names, title='MLP_Custom_RAVDESS_Clean')
#plt.show()

# Save plot as PNG file
fig.savefig('Confusion_Matrix_MLP_Librosa_RAVDESS_Clean.png')
