...
# Rezwan Matin
# Thesis B
# Filename: RNN_Librosa_RAVDESS_Clean_Conf.py
# Date: 10/24/20
#
# Features:
...
fig = plt.figure()
plot_confusion_matrix(confmat, class_names, title='RNN_Custom_RAVDESS_Clean')
#plt.show()

# Save plot as PNG file
fig.savefig('Confusion_Matrix_RNN_Librosa_RAVDESS_Clean.png')
