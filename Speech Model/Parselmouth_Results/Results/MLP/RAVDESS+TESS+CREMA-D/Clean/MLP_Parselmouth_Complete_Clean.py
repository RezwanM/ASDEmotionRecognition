...
# Rezwan Matin
# Thesis B
# Filename: MLP_Parselmouth_Complete_Clean.py
# Date: 10/24/20
#
# Features:
...
df = pd.read_csv(r'/home/r_m727/All_Files/Corpus/Simulated/RAVDESS+TESS+CREMA-D/RAVDESS+TESS+CREMA-D_Parselmouth_Clean.csv', header=0, index_col=0)
...
y_less = df_less.iloc[0:9315, 36].values
# Extract features of majority classes.
X_less = df_less.iloc[0:9315, list(range(36))].values
print(y_less)
...
plt.title('MLP_P.GeMAPS_Complete_Clean')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_MLP_Parselmouth_Complete_Clean.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_MLP_Parselmouth_Complete_Clean.png')
