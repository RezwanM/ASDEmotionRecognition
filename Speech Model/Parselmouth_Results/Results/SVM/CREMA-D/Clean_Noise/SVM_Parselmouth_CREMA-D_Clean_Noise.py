...
# Rezwan Matin
# Thesis B
# Filename: SVM_Parselmouth_CREMA-D_Clean_Noise.py
# Date: 10/24/20
#
# Features:
...
plt.ylabel('Accuracy')
plt.title('SVM_P.GeMAPS_CREMA-D_Clean_Noise')
plt.legend(loc='lower right')
plt.ylim([0.0, 1.0])
#plt.show()

# Save plot as PNG file
fig.savefig('Learning_Curves_SVM_Parselmouth_CREMA-D_Clean_Noise.png')
