...
# Rezwan Matin
# Thesis B
# Filename: RNN_Parselmouth_RAVDESS_Clean.py
# Date: 10/24/20
#
# Features:
...
plt.title('RNN_P.GeMAPS_RAVDESS_Clean')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_RNN_Parselmouth_RAVDESS_Clean.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_RNN_Parselmouth_RAVDESS_Clean.png')
