...
# Rezwan Matin
# Thesis B
# Filename: RNN_Parselmouth_Complete_Clean.py
# Date: 10/24/20
#
# Features:
...
df = pd.read_csv(r'/home/r_m727/All_Files/Corpus/Simulated/RAVDESS+TESS+CREMA-D/RAVDESS+TESS+CREMA-D_Parselmouth_Clean_RNN.csv', header=0, index_col=0)
...
y_less = df_less.iloc[0:9315, 15*median_num_frames].values
# Extract features of majority classes.
X_less = df_less.iloc[0:9315, list(range(15*median_num_frames))].values
print(y_less)
...
plt.title('RNN_P.GeMAPS_Complete_Clean')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_RNN_Parselmouth_Complete_Clean.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_RNN_Parselmouth_Complete_Clean.png')
