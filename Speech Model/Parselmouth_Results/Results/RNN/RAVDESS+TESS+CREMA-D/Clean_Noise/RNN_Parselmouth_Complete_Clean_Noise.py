...
plt.title('RNN_P.GeMAPS_Complete_Clean_Noise')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_RNN_Parselmouth_Complete_Clean_Noise.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_RNN_Parselmouth_Complete_Clean_Noise.png')
