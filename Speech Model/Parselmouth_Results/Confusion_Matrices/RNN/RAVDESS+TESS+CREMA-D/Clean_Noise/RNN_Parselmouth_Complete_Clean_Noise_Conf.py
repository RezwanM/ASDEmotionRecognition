...
# Rezwan Matin
# Thesis B
# Filename: RNN_Parselmouth_Complete_Clean_Noise_Conf.py
# Date: 10/24/20
#
# Features:
...
fig = plt.figure()
plot_confusion_matrix(confmat, class_names, title='RNN_P.GeMAPS_Complete_Clean_Noise')
#plt.show()

# Save plot as PNG file
fig.savefig('Confusion_Matrix_RNN_Parselmouth_Complete_Clean_Noise.png')
