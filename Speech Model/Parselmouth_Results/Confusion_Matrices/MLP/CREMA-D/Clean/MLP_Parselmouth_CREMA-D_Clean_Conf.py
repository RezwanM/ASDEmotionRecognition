...
# Rezwan Matin
# Thesis B
# Filename: MLP_Parselmouth_CREMA-D_Clean_Conf.py
# Date: 10/24/20
#
# Features:
...
fig = plt.figure()
plot_confusion_matrix(confmat, class_names, title='MLP_P.GeMAPS_CREMA-D_Clean')
#plt.show()

# Save plot as PNG file
fig.savefig('Confusion_Matrix_MLP_Parselmouth_CREMA-D_Clean.png')
