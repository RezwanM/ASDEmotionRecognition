...
# Rezwan Matin
# Thesis B
# Filename: SVM_Parselmouth_TESS_Clean_Noise_Conf.py
# Date: 10/24/20
#
# Features:
...
fig = plt.figure()
plot_confusion_matrix(confmat, class_names, title='SVM_P.GeMAPS_TESS_Clean_Noise')
#plt.show()

# Save plot as PNG file
fig.savefig('Confusion_Matrix_SVM_Parselmouth_TESS_Clean_Noise.png')
