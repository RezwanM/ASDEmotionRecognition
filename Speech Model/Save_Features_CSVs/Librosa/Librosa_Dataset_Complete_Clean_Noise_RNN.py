...
# Rezwan Matin
# Thesis B
# Filename: Librosa_Dataset_Complete_Clean_Noise_RNN.py
# Date: 6/22/20
#
# Objective:
...
path = r'/home/r_m727/All_Files/Corpus/Simulated/RAVDESS+TESS+CREMA-D/Clean_Noise'
...
# Save directory path in 'path' (REDUNDANT!)
path = r'/home/r_m727/All_Files/Corpus/Simulated/RAVDESS+TESS+CREMA-D/Clean_Noise'

# Create a list of audio file names 'file_list' (REDUNDANT!)
file_list = os.listdir(path)
...
# Save as CSV file
df.to_csv('RAVDESS+TESS+CREMA-D_Librosa_Clean_Noise_RNN.csv')
