...
# Rezwan Matin
# Thesis B
# Filename: SVM_Librosa_Complete_Clean_Noise_Save.py
# Date: 10/24/20
#
# Features:
...
plt.ylabel('Accuracy')
plt.title('SVM_Custom_Complete_Clean_Noise')
plt.legend(loc='lower right')
plt.ylim([0.0, 1.0])
#plt.show()

# Save plot as PNG file
fig.savefig('Learning_Curves_SVM_Librosa_Complete_Clean_Noise.png')

# Save the model as a pickle file 
joblib.dump(svm, 'SVM_Librosa_Complete_Clean_Noise.pkl')
