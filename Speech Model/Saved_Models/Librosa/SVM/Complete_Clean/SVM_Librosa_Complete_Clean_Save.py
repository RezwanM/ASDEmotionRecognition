...
# Rezwan Matin
# Thesis B
# Filename: SVM_Librosa_Complete_Clean_Save.py
# Date: 10/24/20
#
# Features:
...
np.save('mean_feat_librosa_clean.npy', mean_vals)
np.save('std_feat_librosa_clean.npy', std_val)
...
joblib.dump(svm, 'SVM_Librosa_Complete_Clean.pkl')
