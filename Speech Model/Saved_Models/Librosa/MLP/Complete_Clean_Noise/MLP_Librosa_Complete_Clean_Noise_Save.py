...
# Rezwan Matin
# Thesis B
# Filename: MLP_Librosa_Complete_Clean_Noise_Save.py
# Date: 10/24/20
#
# Features:
...
#np.save('mean_feat_librosa.npy', mean_vals)
#np.save('std_feat_librosa.npy', std_val)
...
fig.savefig('Accuracy_Curves_MLP_Librosa_Complete_Clean_Noise.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_MLP_Librosa_Complete_Clean_Noise.png')

# Save the model as an h5 file
model.save('MLP_Librosa_Complete_Clean_Noise.h5')
