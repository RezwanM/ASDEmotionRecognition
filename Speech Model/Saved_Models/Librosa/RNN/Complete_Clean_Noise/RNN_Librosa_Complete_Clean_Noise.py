...
# Rezwan Matin
# Thesis B
# Filename: RNN_Librosa_Complete_Clean_Noise_Save.py
# Date: 10/24/20
#
# Features:
...
y_less = df_less.iloc[0:18630, 36*median_num_frames].values
# Extract features of majority classes.
X_less = df_less.iloc[0:18630, list(range(36*median_num_frames))].values
print(y_less)
...
np.save('mean_feat_rnn_librosa.npy', mean_vals)
np.save('std_feat_rnn_librosa.npy', std_val)
...
plt.title('RNN_Custom_Complete_Clean_Noise')
plt.grid()
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
fig.savefig('Accuracy_Curves_RNN_Librosa_Complete_Clean_Noise.png')
...
#plt.show()
# Save plot as PNG file
fig.savefig('Loss_Curves_RNN_Librosa_Complete_Clean_Noise.png')

# Save the model as an h5 file
model.save('RNN_Librosa_Complete_Clean_Noise.h5')
